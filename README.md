...
python3 firmware/scripts/generate_manifest.py --repo-root . --target os --version v0.2.13 \
...
```json
{
  ...
  "latest": "v0.2.13",
  "manifest_url": "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.2.13/device/os/manifest.json"
}
```
