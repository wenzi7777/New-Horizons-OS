...
bool BatteryGaugeManager::detectNow(uint32_t nowMs) {
  // A Settings-page detection request must not wait for the regular 1s poll.
  lastPollMs_ = 0;
  service(nowMs);
