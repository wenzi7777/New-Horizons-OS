...
DEFAULT_MANIFESTS = {
    "recovery": "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.2.24/device/recovery/manifest.json",
    "os": "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.2.24/device/os/manifest.json",
}
