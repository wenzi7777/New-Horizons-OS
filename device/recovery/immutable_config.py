...
DEFAULT_MANIFESTS = {
    "recovery": "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.4.15/device/recovery/manifest.json",
    "os": "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.4.15/device/os/manifest.json",
}
