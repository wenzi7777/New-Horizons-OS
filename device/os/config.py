...
FIRMWARE_VERSION = "v0.4.15"
OS_VERSION = FIRMWARE_VERSION
RECOVERY_VERSION = "v0.4.15"
...
WIFI_SERVICE_INTERVAL_MS = 5000
WIFI_SOFT_RETRY_MS = 30000
WIFI_DHCP_PENDING_RETRY_MS = 120000
WIFI_HARD_RESET_AFTER_SOFT_RETRIES = 3
POST_WRITE_NETWORK_RECOVERY_MS = 60000
GATEWAY_DISCOVERY_TIMEOUT_MS = 1500
GATEWAY_DISCOVERY_ATTEMPTS = 2
GATEWAY_DISCOVERY_RETRY_MS = 5000
GITHUB_BASE_URL = "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.4.15/device"
RECOVERY_GITHUB_BASE_URL = "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.4.15/device"
