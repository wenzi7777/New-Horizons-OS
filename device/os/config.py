...
GITHUB_BASE_URL = "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.4.26/device"
RECOVERY_GITHUB_BASE_URL = "https://raw.githubusercontent.com/wenzi7777/New-Horizons-OS/v0.4.25/device"
...
RESOURCE_WATCH_HEAP_FREE = 32768
RESOURCE_WATCH_LARGEST_FREE_BLOCK = 16384
RESOURCE_DEGRADED_HEAP_FREE = 20480
RESOURCE_DEGRADED_LARGEST_FREE_BLOCK = 12288
RESOURCE_CRITICAL_HEAP_FREE = 16384
RESOURCE_CRITICAL_LARGEST_FREE_BLOCK = 8192
RESOURCE_CHECK_EVERY_N_FRAMES = 10
RESOURCE_DEGRADED_SEND_EVERY_N_FRAMES = 2

# 1 = send every scanned frame.
# 2 = scan at 60Hz, send at 30Hz.
# 3 = scan at 60Hz, send at 20Hz.
SEND_EVERY_N_FRAMES = 1
MAX_SEND_EVERY_N_FRAMES = 8
