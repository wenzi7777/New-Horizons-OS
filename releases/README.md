...
VERSION=vX.Y.Z firmware/scripts/build_arduino_release_v15f.sh
```
...
- `releases/arduino-v15f-latest.json` and `releases/arduino-v15f-vX.Y.Z.json` for `VD-CTL/R v1.5.F 2026.7`
